 ...
 <!--
    <!-- <section class="nav">
        <nav class="open-nav yw-container">
            <ul>
                <li>
                    <img src="./individual_center_files/logo.png">
                </li>
                <li><a href="https://open.yiban.cn/">首页</a></li>
                <li><a href="https://open.yiban.cn/wiki/index.php?page=%E5%B9%B3%E5%8F%B0%E4%BB%8B%E7%BB%8D" target="_blank">文档中心</a></li>
                <li><a href="https://open.yiban.cn/manage/index">管理中心</a></li>
                
                <li><a href="/help/index">支持中心</a></li>
               
                <li><a href="https://open.yiban.cn/help/problem">支持中心</a></li>
                                <li class="message-box">
                                        <a href="https://open.yiban.cn/global/msgbox" title="消息盒子">
                        <i class="iconfont icon-message"></i>
                    </a>
                </li>
                <li class="nav-user">
                    <img src="./individual_center_files/200">
                    <span>李永辉</span>
                    <div class="sub-menu">
                        <div class="cont"><a href="https://open.yiban.cn/global/user">个人中心</a></div>
                        <div class="cont"><a href="https://open.yiban.cn/ajax/logout">退出账号</a></div>
                    </div>
                </li>
                            </ul>
        </nav>
    ...
    <section class="yw-container">
        ...
        <form class="app-modify user-info">
            ...
            <div class="form-group">
                <label class="yw-label">地址</label>
                <input class="yw-input email" type="text" id="change_email" value="法国里昂花后区公主坟" placeholder="请填写常用补课地址">
            </div>
            <div class="form-group">
                <label class="yw-label">手机号码</label>
                <input class="yw-input cellphone" type="text" id="change_phone" value="18700575796"
                    placeholder="请填写常用联系手机号码">
            </div>
            ...
            <div class="form-group">
                <label class="yw-label">性别</label>
                <div class="radio-group">
                    <div class="iradio disabled" style="position: relative;"><input type="radio" name="reg_type"
                            class="type_0" value="0" disabled="disabled" style="position: absolute; opacity: 0;"><ins
                            class="iCheck-helper"
                            style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins><span
                            class="iradio-icon"></span></div>男
                </div>
                <div class="radio-group">
                    <div class="iradio checked disabled" style="position: relative;"><input type="radio" name="reg_type"
                            class="type_1" value="1" disabled="disabled" style="position: absolute; opacity: 0;"><ins
                            class="iCheck-helper"
                            style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins><span
                            class="iradio-icon"></span></div>女
                </div>
            </div>
            <div class="form-group">
                <label class="yw-label">姓名</label>
                <input class="yw-input" disabled="disabled" type="text" value="赵薇">
            </div>
            <!--
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="yw-input" disabled="disabled" type="text" value="23432">
            </div>
            <div class="form-group">
                <label class="yw-label">用户名</label>
                <input class="yw-input" type="text" value="赵微老师">
            </div>
            <div class="form-group">
                <label class="yw-label">密码</label>
                <input class="yw-input" type="password">
            </div>
            <div class="form-group">
                <label class="yw-label">年级</label>
                <input class="yw-input" type="text" value="高中"">
            </div>
            <div class=" form-group">
                <label class="yw-label">科目</label>
                <input class="yw-input" type="text" value="英语">
            </div>

            <div class="form-group">
                <div class="yw-btn bright-blue btn-save updusercall">保存设置</div>
            </div>
            <!--
            <div class="form-group">
    ...
    <div id="kickIe" style="display: none">
        您使用的浏览器版本较低，会影响网站部分功能，请切换成
        <a class="kick_jisu" href="javascript:void(0)">极速模式</a>
        或升级。
        <a class="kick_upgrade" href="http://windows.microsoft.com/zh-cn/windows/upgrade-your-browser"
            target="_blank">立刻升级</a>
        <em class="kick_close">×</em>
    </div>
    ...
    <div id="kickIe_con">
        <div class="kickIe_con_padd">
            <div class="kickIe_con_head">
                <h5>请选择您目前使用的浏览器：</h5>
                <a class="kickIe_con_close" href="https://open.yiban.cn/global/user#">×</a>
                <div class="kickIe_con_ie grid">
                    <div class="list_1 active pull-left"><a href="https://open.yiban.cn/global/user#tab1">360安全浏览器</a>
                    </div>
                    <div class="list_2 pull-left"><a href="https://open.yiban.cn/global/user#tab2">360急速浏览器</a></div>
                    <div class="list_3 pull-left"><a href="https://open.yiban.cn/global/user#tab3">搜狗浏览器</a></div>
                    <div class="list_4 pull-left"><a href="https://open.yiban.cn/global/user#tab4">遨游浏览器</a></div>
                    <div class="list_5 pull-left"><a href="https://open.yiban.cn/global/user#tab5">猎豹浏览器</a></div>
                    <div class="list_6 pull-left"><a href="https://open.yiban.cn/global/user#tab6">百度浏览器</a></div>
                    <div class="list_7 pull-left"><a href="https://open.yiban.cn/global/user#tab7">其他浏览器</a></div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="./individual_center_files/jquery1.11.0.min.js"></script>
    <script type="text/javascript" src="./individual_center_files/jquery.form.js"></script>
    <script type="text/javascript" src="./individual_center_files/html5shiv.js"></script>
    <script type="text/javascript" src="./individual_center_files/respond.min.js"></script>
    <script type="text/javascript" src="./individual_center_files/compat.js"></script>
