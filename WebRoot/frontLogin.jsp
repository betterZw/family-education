...
<html class="expanded">
	...
	<script async="" src="./files/analytics.js"></script><script src="https://hm.baidu.com/hm.js?2158a4d2a4a595edf73129ee30dd7481"></script><script type="text/javascript" async="" defer="" src="./files/piwik.js"></script><script type="text/javascript" src="./files/4b9d2a8b77e041c761bcd1d626488278.js"></script><!--[if lt IE 9]> 	
...
<link rel="stylesheet" href="./files/common_40bb2b7.css"><link rel="stylesheet" href="./files/all_87c2b88.css"><link rel="stylesheet" href="./files/minimalist_04aeee2.css"><link rel="stylesheet" href="./files/fullpage_f1b36a2.css"><link rel="stylesheet" href="./files/widget_bacafe3.css"><link rel="stylesheet" href="./files/declaration-popup_e299361.css"><link rel="stylesheet" href="./files/sem-zixun_869585e.css"><script type="text/javascript" src="./files/picker_b092db4.js"></script><style type="text/css">#waf_nc_block {position: fixed;_position: absolute;width: 100%;height: 100%;top: 0;bottom: 0;left: 0;z-index: 9999;}.waf-nc-mask {background: #f8f8f8;opacity: 0.5;filter:alpha(opacity=50); width: 100%;height: 100%;} .waf-nc-wrapper {width:480px; height:254px; position: absolute; top: 50%; left: 50%; margin-top: -127px; margin-left: -240px; margin-bottom: 16px; background:#ffffff; border:3px solid #00A2CA;} .waf-nc-icon {position: absolute;top: 18px;left: 20px;} .waf-nc-title {margin-top: 23px; margin-left: 47px; font-size:16px; color:#333333; line-height:10px; text-align:left;} .waf-nc-splitter {margin-left: 26px; margin-top: 5px; width:430px; height:0px; border:1px solid #f4f4f4; } .waf-nc-description { margin-top: 22px; margin-left: 23px; font-size:12px; color:#333333; text-align: left; } #nocaptcha { margin-top: 20px; margin-left: 92px; width:300px; height36px;}</style><script src="./files/nc.js"></script><style>@charset "utf-8";
    ...
    <div class="contactUs">
        <div class="layout">
            <div class="AboutUs">
                <ul class="zmLogo">
                    <li>
                        <a href="https://www.zhangmen.com/"><img src="./files/zmLogo_210efeb.png" title="掌门1对1官网" alt="掌门1对1官网Logo图片"></a>
                    </li>
                </ul>
            ...
            <div class="cerfication col-rr">
                ...
                <div class="authentication col-rr">
                    <a class="anquan" key="574bdb6fefbfb00a5a3c3e43" logo_size="83x30" logo_type="business" href="https://v.pinpaibao.com.cn/authenticate/cert/?site=www.zhangmen.com&at=business" target="_blank" rel="nofollow">
                        <img src="./files/safe_230f939.png" alt="安全联盟认证" width="83" height="30" style="border: none;">
                    </a>
                </div>
            </div>
        </div>
...
</div><div id="waf_nc_block" style="display: none;"><div class="waf-nc-mask"></div><div id="WAF_NC_WRAPPER" class="waf-nc-wrapper"><img class="waf-nc-icon" src="./files/TB1_3FrKVXXXXbdXXXXXXXXXXXX-129-128.png" alt="" height="20" width="20"><p class="waf-nc-title">安全验证</p><div class="waf-nc-splitter"></div><p class="waf-nc-description">请完成以下验证后继续操作：</p><div id="nocaptcha"></div></div></div></body></html>